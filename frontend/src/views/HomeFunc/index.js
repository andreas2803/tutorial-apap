...
function App() {
    ...
    function handleAddItemToCart(item) {
        const check = balanceDikurang(item.price);
        if(check === true) {
    ...
    function balanceDikurang(price) {
        const selisih = balance - price;
        if(selisih < 0) {
    ...
    function balanceDitambah(price) {
        const jumlah = balance + price;
        setBalance(jumlah);
    }
